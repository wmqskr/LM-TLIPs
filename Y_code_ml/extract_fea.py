...
def extract_fea(Data, label, m):
    ...
    esm2model.load_state_dict(torch.load('../Result/Y_esm2_t33_model.pth', map_location='cuda:1'))
    esm2model.eval()
    ...
    if m == 1:
        np.save("../Result/Y_sequence_extract_fea/train_esm2_fea.npy", esm2_fea)
        np.save("../Result/Y_sequence_extract_fea/train_labels.npy", labels)
    elif m == 2:
        np.save("../Result/Y_sequence_extract_fea/test_esm2_fea.npy", esm2_fea)
        np.save("../Result/Y_sequence_extract_fea/test_labels.npy", labels)
